...
class Account(AbstractBaseUser):
    ...
    username        = models.CharField(max_length=50, verbose_name ='Usuario', unique=True)
    email           = models.EmailField(max_length=100, unique=True)
    phone_number    = models.CharField(max_length=50, verbose_name ='Teléfono')

    # required
    date_joined     = models.DateTimeField(auto_now_add=True, verbose_name ='F. Ingreso')
    last_login      = models.DateTimeField(auto_now_add=True, verbose_name ='Ultimo acceso')
...
class UserProfile(models.Model):
    ...
    profile_picture = models.ImageField(blank=True, upload_to='avatarusuario',)
